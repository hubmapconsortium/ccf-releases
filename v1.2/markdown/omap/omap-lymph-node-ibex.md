...
| **Data Table:** | Organ Mapping Antibody Panel (OMAP) for Multiplexed Antibody-Based Imaging of Human Lymph Node with IBEX v1.1 [CSV](https://cdn.humanatlas.io/hra-releases/v1.2/omap/OMAP_Human_Lymph_Node_IBEX.csv) [Excel](https://cdn.humanatlas.io/hra-releases/v1.2/omap/OMAP_Human_Lymph_Node_IBEX.xlsx) |
