...
| **Data Table:** | Organ Mapping Antibody Panel (OMAP) for Multiplexed Antibody-Based Imaging of Human Intestine with CODEX v1.0 [CSV](https://cdn.humanatlas.io/hra-releases/v1.2/omap/OMAP_Intestine_CODEX.csv) [Excel](https://cdn.humanatlas.io/hra-releases/v1.2/omap/OMAP_Intestine_CODEX.xlsx) |
