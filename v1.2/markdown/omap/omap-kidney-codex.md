...
| **Data Table:** | Organ Mapping Antibody Panel (OMAP) for Multiplexed Antibody-Based Imaging of Human Kidney with CODEX v1.0 [CSV](https://cdn.humanatlas.io/hra-releases/v1.2/omap/OMAP_Kidney_CODEX.csv) [Excel](https://cdn.humanatlas.io/hra-releases/v1.2/omap/OMAP_Kidney_CODEX.xlsx) |
