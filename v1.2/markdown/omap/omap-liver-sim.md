...
| **Data Table:** | Organ Mapping Antibody Panel (OMAP) for Multiplexed Antibody-Based Imaging of Human Liver with SIMS v1.0 [CSV](https://cdn.humanatlas.io/hra-releases/v1.2/omap/OMAP_Liver_SIMS.csv) [Excel](https://cdn.humanatlas.io/hra-releases/v1.2/omap/OMAP_Liver_SIMS.xlsx) |
